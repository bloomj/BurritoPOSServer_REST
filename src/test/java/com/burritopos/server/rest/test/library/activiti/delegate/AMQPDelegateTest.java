 ...
 *
 */
public class AMQPDelegateTest extends WorkflowActivitiTest {
     ...
     * @throws IOException
     */
    public AMQPDelegateTest() throws IOException {
    	super();
    }
    
    /**
     * Tests for successful completion of BPMN process that has AMQPDelegate service task defined
     *
     * @throws Exception
     */
    @Test
    @Category(BuildTests.class)
    public void testAMQPDelegateBPMN() throws Exception {
        taskInstanceAndComplete("AMQPDelegate.bpmn20.xml","AMQPDelegate");
    }
}
